...
function Users() {
    ...
    const handleRoleChange = async (userId, newRole) => {
        try {
            ...
            console.error(error); usersToast.error("Error", "An error occurred while updating role")
        }
    }
    ...
    const handlePageChange = (page) => {
        if (page >= 1 && page <= totalPages && page !== currentPage) fetchUsers(page)
    }
    ...
    return (
        ...
        >
            ...
            <ViewUserModal isOpen={showViewModal} onClose={() => { setShowViewModal(false); setSelectedUser(null) }} user={selectedUser} />
                ...
                <div className="dropDown-portal fixed z-[9999]" style={{ top: dropDownPosition.top, left: dropDownPosition.left }}>
                    <div className="w-44 py-1 rounded-xl shadow-xl border
                        ...
                        <button
                            ...
                            onClick={() => {
                                setSelectedUser(users.find((u) => u.id === openDropDown))
